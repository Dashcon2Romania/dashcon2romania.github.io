...
<table>
 ...
 <tr>
    <td>
     ...
     <br>
     No. While we are in close contact with the DashCon 2 team, they are not involved in the organisation of this event. We've licensed the "DashCon 2" name from them and they're enthusiastically cheering from the side for us.
     <br>
      <br>
      <strong>Can I start my own DashCon 2 in my city/country?</strong>
      <br>
      You'd have to ask them! We needed their explicit permission and to pay a licensing fee to use the brand. Emailing them at queries@dashcontwo.com is probably a good place to start.
      <br>
       <br>
  ...
  <td>
   <p style="text-align:center;">
    ...
    <br>
    Nu. Chiar dacă ne-au îndrumat mult și ținem legătura, ei nu sunt implicați în organizarea acestui eveniment. Doar am cumpărat licența numelui de "DashCon 2" de la ei și ne susțin de la distanță!
    <br>
     <br>
    <strong>Pot să organizez propriul DashCon 2 în orașul/țara mea?</strong>
    <br>
    Ar trebui să îi întrebați pe ei! Este nevoie de permisiunea lor clară și plata unei taxe de licență pentru a utiliza numele. Puteți începe prin a le trimite un e-mail la adresa queries@dashcontwo.com.
    <br>
     <br>
    <strong>Cine sunteți?</strong>
    <br>
     Suntem o mică echipă de cosplayeri români care iubesc tot ce ține de fandom și cultura online!
    <br>
    <br>
    ...
    <br>
     Fiind chronically online de când eram mici, Dashcon a fost mereu un simbol al acceptării și al creativității.
    <br>
    <br>
   Acum vrem sa aducem această experiență a unei convenții tip Dashcon 2 și în colțul nostru de lume, atât pentru comunitatea noastră locală cât și pentru oricine altcineva ar dori să participe la convenția originală dar nu poate din motive monetare, de distanță și așa mai departe.
    <br>
   <br>
     Sperăm ca versiunea noastră mai restrânsă a evenimentului să vă poată aduce tuturor o parte din magia autentică Dashcon și multă distracție!
    <br>
      <br>
